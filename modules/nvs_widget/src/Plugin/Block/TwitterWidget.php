...
class TwitterWidget extends BlockBase {
  ...
  public function getTweets(){
    ...
    $tweetout = '<ul class="w-list-unstyled">';
...
//        print_r($value);
        ...
        $tweetout .= '
            <li class="w-clearfix tweets-ul">
            <div class="tweets_txt" style="">
            '.' <a  href="http://twitter.com/'.$value->user->name.'"> @'.$value->user->name.'</a> '.$this->makeClickableLinks($status).'<div class="date" > '.$this->twitter_time($created).'</div>
            </div></li>';
      }
